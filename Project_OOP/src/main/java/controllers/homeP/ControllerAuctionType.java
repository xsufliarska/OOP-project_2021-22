...
public class ControllerAuctionType extends ControllerHomePageTopBar implements Initializable {
    ...
    void FPSB_Auction_START(ActionEvent event) throws IOException {
        BorderPane pane = FXMLLoader.load(getClass().getResource("/fxml/homeP/auctionsItemChoose.fxml"));
